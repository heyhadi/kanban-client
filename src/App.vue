<template>
    <section>
        ...
        <homepage v-if="pageName == 'home-page'" :categories="categories" :tasks="tasks" @deleteTask="deleteTask" @patchTask="patchTask">
        </homepage>
        ...
        <editForm v-if="pageName =='edit-form'" :propsedit="editTask" @change-page="changePage"></editForm>
...
export default {
    name:'App',
    components: {navbar, homepage, login, signUp, addForm, editForm},
